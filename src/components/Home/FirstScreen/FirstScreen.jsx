      ...
      <Container>
        <div className={component["first-screen__content"]}>
          <div className={component["first-screen__info"]}>
            ...
            <h1 className={component["first-screen__title"]}>We're <span>developers</span></h1>
          ...
          <div className={component["first-screen__image"]}>
            <img className={component["first-screen__img"]} src="images/img/first_screen/man.png" alt="man" width={500}/>
          </div>
        </div>
      </Container>
    </div>
